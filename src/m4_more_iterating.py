...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 4
    actual = count_positive_sines([9, 20, 3, 5, 8])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 9:
    expected = 20
    actual = sum_first_n([20, 19, 18, 17, 16, 15], 1)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
